...
const associationRules: RecommendationRule[] = [
  {
    ...
    reason: "Los clientes que compran proteina suelen completar su stack con creatina.",
  ...
  },
  {
    ...
    reason: "Este accesorio aparece frecuentemente cuando se combinan suplementos en polvo.",
  ...
  },
  {
    ...
    reason: "Se recomienda como complemento para rutinas de fuerza e intensidad.",
  ...
  },
  {
    ...
    reason: "Los usuarios que compran pre-entreno tambien compran aminoacidos para recuperacion.",
  ...
  },
  {
    ...
    reason: "Complemento comun en objetivos de control de peso y bienestar general.",
  ...
  },
  {
    ...
    reason: "Se compra junto a accesorios de fuerza para mejorar agarre y seguridad.",
