...
export default function AdminAboutPage() {
  ...
  const [editingMemberImage, setEditingMemberImage] = useState<File | null>(null);
  ...
  const moveValue = async (id: string, direction: "up" | "down") => {
    ...
    const target =
      direction === "up" ? Math.max(index - 1, 0) : Math.min(index + 1, order.length - 1);
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.card}>
        ...
        {about?.heroImageUrl && (
          <img className={styles.preview} src={about.heroImageUrl} alt="Hero actual" />
        )}
      </div>
      ...
      <div className={styles.card}>
        ...
        {about?.introImageUrl && (
          <img className={styles.preview} src={about.introImageUrl} alt="Intro actual" />
        )}
      </div>

      <div className={styles.card}>
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle}>Misión, visión y bloque de valores</h2>
        </div>
        ...
        <div className={styles.formGrid}>
          ...
          <label className={styles.field}>
            ...
            <input
              ...
              onChange={(e) => updateField("ctaPrimaryButtonLink", e.target.value)}
            />
          </label>
      ...
      <div className={styles.grid2}>
        <div className={styles.card}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionText}>Agrega, edita, elimina y ordena.</p>
          </div>
          ...
          <div className={styles.actionsBar}>
            <button className={styles.primaryBtn} type="button" onClick={handleCreateValue}>
              Agregar valor
            </button>
          </div>
                  ...
                  {editingValueId === item.id ? (
                    <>
                      <div className={styles.formGrid}>
                        <label className={styles.field}>
                          ...
                          <input
                            ...
                            onChange={(e) => setEditingValueTitle(e.target.value)}
                          />
                        </label>
                        ...
                        <label className={styles.field}>
                          ...
                          <input
                            ...
                            onChange={(e) => setEditingValueIconKey(e.target.value)}
                          />
                        </label>
                      ...
                      <div className={styles.actions}>
                        <button className={styles.btnGhost} onClick={handleSaveValueEdit}>
                          Guardar
                        </button>
                        <button className={styles.btnGhost} onClick={cancelEditValue}>
                          Cancelar
                        </button>
                      </div>
                    </>
                    ...
                    <>
                      <div>
                        ...
                        <div className={styles.itemMeta}>Icono: {item.iconKey || "shield"}</div>
                        <div className={styles.itemText}>{item.description}</div>
                      </div>

                      <div className={styles.actions}>
                        <button className={styles.btnGhost} onClick={() => moveValue(item.id, "up")}>
                          ↑
                        </button>
                        <button className={styles.btnGhost} onClick={() => moveValue(item.id, "down")}>
                          ↓
                        </button>
                        <button className={styles.btnGhost} onClick={() => startEditValue(item)}>
                          Editar
                        </button>
                        <button className={styles.btnDanger} onClick={() => handleDeleteValue(item.id)}>
                          Eliminar
                        </button>
                      </div>
                    </>
        ...
        <div className={styles.card}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionText}>Gestiona integrantes y sus fotos.</p>
          </div>
          ...
          <div className={styles.actionsBar}>
            <button className={styles.primaryBtn} type="button" onClick={handleCreateTeamMember}>
              Agregar miembro
            </button>
          </div>
                ...
                <div key={member.id} className={styles.listCard}>
                  {editingMemberId === member.id ? (
                    <>
                      <div className={styles.formGrid}>
                        ...
                        <label className={`${styles.field} ${styles.full}`}>
                          ...
                          <textarea
                            ...
                            onChange={(e) => setEditingMemberDescription(e.target.value)}
                          />
                        </label>
                        ...
                        <label className={styles.field}>
                          ...
                          <input
                            ...
                            onChange={(e) => setEditingMemberFacebook(e.target.value)}
                          />
                        </label>
                        ...
                        <label className={styles.field}>
                          ...
                          <input
                            ...
                            onChange={(e) => setEditingMemberTwitter(e.target.value)}
                          />
                        </label>
                        ...
                        <label className={styles.field}>
                          ...
                          <input
                            ...
                            onChange={(e) => setEditingMemberLinkedin(e.target.value)}
                          />
                        </label>
                      ...
                      <div className={styles.actions}>
                        <button className={styles.btnGhost} onClick={handleSaveMemberEdit}>
                          Guardar
                        </button>
                        <button className={styles.btnGhost} onClick={cancelEditMember}>
                          Cancelar
                        </button>
                      </div>
                    </>
                    ...
                    <>
                      <div className={styles.memberRow}>
                        <img
                          ...
                          src={member.imageUrl || "https://via.placeholder.com/64"}
                          alt={member.name}
                        />
                        <div>
                          <div className={styles.itemTitle}>
                      ...
                      <div className={styles.actions}>
                        <button className={styles.btnGhost} onClick={() => moveMember(member.id, "up")}>
                          ↑
                        </button>
                        <button className={styles.btnGhost} onClick={() => moveMember(member.id, "down")}>
                          ↓
                        </button>
                        <button className={styles.btnGhost} onClick={() => startEditMember(member)}>
                          Editar
                        </button>
                        <button
